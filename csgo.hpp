...
// 2020-05-20 05:50:00.580333200 UTC
...
constexpr ::std::ptrdiff_t dwEntityList = 0x4D4A0D4;
constexpr ::std::ptrdiff_t dwForceAttack = 0x317B6BC;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x317B6C8;
constexpr ::std::ptrdiff_t dwForceBackward = 0x317B674;
constexpr ::std::ptrdiff_t dwForceForward = 0x317B680;
constexpr ::std::ptrdiff_t dwForceJump = 0x51F3D4C;
constexpr ::std::ptrdiff_t dwForceLeft = 0x317B698;
constexpr ::std::ptrdiff_t dwForceRight = 0x317B68C;
constexpr ::std::ptrdiff_t dwGameDir = 0x6286F8;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x526702C;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xD5BF2C;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x589AD8;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x5291EB8;
constexpr ::std::ptrdiff_t dwInput = 0x519B668;
constexpr ::std::ptrdiff_t dwInterfaceLinkList = 0x8FED44;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xD35B94;
constexpr ::std::ptrdiff_t dwMouseEnable = 0xD3B738;
constexpr ::std::ptrdiff_t dwMouseEnablePtr = 0xD3B708;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x3179A0C;
constexpr ::std::ptrdiff_t dwRadarBase = 0x517EE2C;
constexpr ::std::ptrdiff_t dwSensitivity = 0xD3B5D4;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xD3B5A8;
constexpr ::std::ptrdiff_t dwSetClanTag = 0x89F00;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4D3BA04;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x519C12C;
constexpr ::std::ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ::std::ptrdiff_t dwYawPtr = 0xD3B398;
constexpr ::std::ptrdiff_t dwZoomSensitivityRatioPtr = 0xD405E0;
constexpr ::std::ptrdiff_t dwbSendPackets = 0xD3EFA;
constexpr ::std::ptrdiff_t dwppDirect3DDevice9 = 0xA7030;
constexpr ::std::ptrdiff_t find_hud_element = 0x31FFF890;
constexpr ::std::ptrdiff_t force_update_spectator_glow = 0x39C6E2;
constexpr ::std::ptrdiff_t interface_engine_cvar = 0x3E9EC;
constexpr ::std::ptrdiff_t is_c4_owner = 0x3A8EE0;
constexpr ::std::ptrdiff_t m_bDormant = 0xED;
constexpr ::std::ptrdiff_t m_flSpawnTime = 0xA360;
constexpr ::std::ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x517F0D0;
constexpr ::std::ptrdiff_t m_yawClassPtr = 0xD3B398;
constexpr ::std::ptrdiff_t model_ambient_min = 0x58CE4C;
constexpr ::std::ptrdiff_t set_abs_angles = 0x1D2640;
constexpr ::std::ptrdiff_t set_abs_origin = 0x1D2480;
} // namespace signatures
} // namespace hazedumper
